...
void gimbal_task(void const *pvParameters)
{
    ...
    while (1)
    {
        ...
        CAN_cmd_gimbal(yaw_can_set_current, pitch_can_set_current, 0, 0); // yaw_can_set_current
...
static void gimbal_set_control(gimbal_control_t *set_control)
{
    ...
    {
        gimbal_absolute_YAW_angle_Visionlimit(&set_control->gimbal_yaw_motor, add_yaw_angle);
    }
