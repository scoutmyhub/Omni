...
static void chassis_mode_change_control_transit(chassis_move_t *chassis_move_transit)
{
  ...
  else if ((chassis_move_transit->last_chassis_mode != CHASSIS_VECTOR_ROT) && chassis_move_transit->chassis_mode == CHASSIS_VECTOR_ROT)
  {
    chassis_move_transit->chassis_yaw_set = chassis_move_transit->chassis_yaw;
  }
...
static void chassis_set_contorl(chassis_move_t *chassis_move_control)
{
  ...
  else if (chassis_move_control->chassis_mode == CHASSIS_VECTOR_ROT)
  {
    fp32 sin_yaw = 0.0f, cos_yaw = 0.0f;
    ...
    chassis_move_control->chassis_relative_angle_set = rad_format(1.570796326912f/2);
